...
if(isset($_POST['submit'])){
	 ...
	 $myname = $_POST['name'];
	  ...
	  $sql ="INSERT INTO customer (id, name,mobile,email,dateofbirth,address,city,state,country) VALUES ('$myid','$myname','$mymobile', '$myemail', '$mydateofbirth', '$myaddress', '$mycity', '$mystate', '$mycountry')";
  ...
  <ul class="navbar-nav">
	...
	<li class="nav-item">
      <a class="nav-link" href="login.php">LOGOUT</a>
				...
				<!--content part start-->
				<div class="container">
				<header class="about_part"style = "background-color:#0A2A0A;">
				<div class="row">
				<div class="col-lg-12">
				<div class="head_mid">
				</div>
				...
				<div class="container" >
				<section class="service_part" style = "background-color:#A9F5E1;" >
         ...
         <div style = "width:450px; border: solid 1px #333333; background-color:#81F79F; margin-bottom:15px;" align = "left" >
